...
var require_sequential_executor = __commonJS({
  "node_modules/aws-sdk/lib/sequential_executor.js"(exports2, module2) {
    ...
    module2.exports = AWS.SequentialExecutor;
  }
});
      ...
      coalesceRefresh: function coalesceRefresh(callback, sync) {
        ...
        if (self.refreshCallbacks.push(callback) === 1) {
          self.load(function onLoad(err) {
            AWS.util.arrayEach(self.refreshCallbacks, function(callback2) {
              if (sync) {
                callback2(err);
              } else {
        ...
        if (self.resolveCallbacks.push(callback) === 1) {
          let resolveNext2 = function(err, creds) {
            if (!err && creds || index === providers.length) {
              AWS.util.arrayEach(self.resolveCallbacks, function(callback2) {
                callback2(err, creds);
              });
    ...
    AWS.Endpoint = inherit({
      ...
      constructor: function Endpoint(endpoint, config) {
        ...
        if (!endpoint.match(/^http/)) {
          var useSSL = config && config.sslEnabled !== void 0 ? config.sslEnabled : AWS.config.sslEnabled;
      ...
      CorePost: new SequentialExecutor().addNamedListeners(function(add) {
        ...
        add("ENOTFOUND_ERROR", "httpError", function ENOTFOUND_ERROR(err) {
          function isDNSError(err2) {
            return err2.errno === "ENOTFOUND" || typeof err2.errno === "number" && typeof AWS.util.getSystemErrorName === "function" && ["EAI_NONAME", "EAI_NODATA"].indexOf(AWS.util.getSystemErrorName(err2.errno) >= 0);
          }
...
var require_v2 = __commonJS({
  "node_modules/aws-sdk/lib/signers/v2.js"(exports2, module2) {
    ...
    module2.exports = AWS.Signers.V2;
  }
});
...
var require_v3 = __commonJS({
  "node_modules/aws-sdk/lib/signers/v3.js"(exports2, module2) {
    ...
    module2.exports = AWS.Signers.V3;
  }
});
...
var require_v3https = __commonJS({
  "node_modules/aws-sdk/lib/signers/v3https.js"(exports2, module2) {
    ...
    module2.exports = AWS.Signers.V3Https;
  }
});
...
var require_v4 = __commonJS({
  "node_modules/aws-sdk/lib/signers/v4.js"(exports2, module2) {
    ...
    module2.exports = AWS.Signers.V4;
  }
});
...
var require_s3 = __commonJS({
  "node_modules/aws-sdk/lib/signers/s3.js"(exports2, module2) {
    ...
    module2.exports = AWS.Signers.S3;
  }
});
...
var require_presign = __commonJS({
  "node_modules/aws-sdk/lib/signers/presign.js"(exports2, module2) {
    ...
    function signedUrlBuilder(request) {
      ...
      if (signerClass === AWS.Signers.V4) {
        ...
        request.httpRequest.headers[expiresHeader] = parseInt(
          AWS.util.date.unixTimestamp(now) + expires,
          10
        ).toString();
      } else {
        throw AWS.util.error(new Error(), {
    ...
    module2.exports = AWS.Signers.Presign;
  }
});
  ...
  "node_modules/aws-sdk/lib/param_validator.js"() {
    ...
    AWS.ParamValidator = AWS.util.inherit({
      ...
      fail: function fail(code, message) {
        this.errors.push(AWS.util.error(new Error(message), { code }));
      },
    ...
    var util = {
      ...
      date: {
        ...
        getDate: function getDate() {
          if (!AWS) AWS = require_core2();
          if (AWS.config.systemClockOffset) {
            return new Date((/* @__PURE__ */ new Date()).getTime() + AWS.config.systemClockOffset);
          } else {
      ...
      applyClockOffset: function applyClockOffset(serverTime) {
        if (serverTime)
          AWS.config.systemClockOffset = serverTime - (/* @__PURE__ */ new Date()).getTime();
      },
      /**
       * @api private
       */
      ...
      addPromises: function addPromises(constructors, PromiseDependency) {
        ...
        if (PromiseDependency === void 0 && AWS && AWS.config) {
      ...
      ARN: {
        ...
        build: function buildARN(arnObject) {
          if (arnObject.service === void 0 || arnObject.region === void 0 || arnObject.accountId === void 0 || arnObject.resource === void 0) throw util.error(new Error("Input ARN object is invalid"));
...
var require_cognitoidentity = __commonJS({
  "node_modules/aws-sdk/clients/cognitoidentity.js"(exports2, module2) {
    ...
    module2.exports = AWS.CognitoIdentity;
  }
});
...
var require_metadata_service = __commonJS({
  "node_modules/aws-sdk/lib/metadata_service.js"(exports2, module2) {
    ...
    module2.exports = AWS.MetadataService;
  }
});
...
var require_node_loader = __commonJS({
  "node_modules/aws-sdk/lib/node_loader.js"(exports2, module2) {
    ...
    var AWS;
    module2.exports = AWS = require_core2();
    require_credentials();
    require_credential_provider_chain();
    ...
    AWS.XML.Parser = require_node_parser();
    require_node();
    require_ini_loader();
...
var require_converter = __commonJS({
  "node_modules/aws-sdk/lib/dynamodb/converter.js"(exports2, module2) {
    ...
    module2.exports = AWS.DynamoDB.Converter;
  }
});
...
var require_document_client = __commonJS({
  "node_modules/aws-sdk/lib/dynamodb/document_client.js"(exports2, module2) {
    ...
    module2.exports = AWS.DynamoDB.DocumentClient;
  }
});
...
var require_dynamodb2 = __commonJS({
  "node_modules/aws-sdk/clients/dynamodb.js"(exports2, module2) {
    ...
    module2.exports = AWS.DynamoDB;
  }
});

// src/domain/interfaces/controllers/PersonController.ts
...
var PersonDBRepository = class {
  constructor() {
    this.dynamodb = new import_dynamodb.DocumentClient();
  }
...
var PersonDBRepository_default = PersonDBRepository;

// src/application/services/PersonService.ts
var PersonService = class {
  constructor() {
    this.personDBRepository = new PersonDBRepository_default();
  }
  // Método para agregar una nueva persona
  async addPerson(personData) {
    const newPerson = {
      id: Date.now().toString(),
      // Genera un ID único simple, puedes cambiar esto a otro sistema de IDs.
      ...personData
    };
...
var PersonService_default = PersonService;

// src/domain/interfaces/controllers/PersonController.ts
var personService = new PersonService_default();
var addPerson = async (event) => {
  try {
    ...
    return {
      ...
      // Retorna la nueva persona en la respuesta
    };
  } catch (error) {
...
var addPersonHandler = (0, import_core.default)(addPerson).use((0, import_http_json_body_parser.default)());
var getPersonsHandler = getPersons;
