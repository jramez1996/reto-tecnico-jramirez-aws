...
// src/domain/interfaces/controllers/StarWarsController.ts
var StarWarsController_exports = {};
__export(StarWarsController_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(StarWarsController_exports);
...
// src/infrastructure/http/StarWarsHttpClient.ts
var dotenv = __toESM(require_main());
dotenv.config();
var StarWarsHttpClient = class {
  constructor() {
  ...
  async getStarWars() {
    try {
      const response = await this.client.get(`/people/?page=1`);
...
var StarWarsHttpClient_default = StarWarsHttpClient;

// src/domain/models/PersonStarWas.ts
var PersonStarWas = class {
  ...
  toString() {
    return `Persona Star Wars - Nombre: ${this.nombre}, G\xE9nero: ${this.genero}, Nacido en: ${this.anioDeNacimiento}`;
  }
};

// src/domain/models/TransformedStarWarsResponse.ts
var TransformedStarWarsResponse = class {
  constructor(total, nextPage, previousPage, personas = []) {
    this.total = total;
...
// src/application/transformers/StarWarsTransformers.ts
var UserTransformer = class {
  static formatStarWarsResponse(apiResponse) {
    const personas = apiResponse.results.map((user) => {
    ...
    const transformedResponse = new TransformedStarWarsResponse(
      ...
      personas
      // Personas vacías, ya que no se están transformando en este punto
    );
    return transformedResponse;
  }
};
var StarWarsTransformers_default = UserTransformer;

// src/application/services/StarWarsService.ts
var StarWarsService = class {
  constructor() {
    this.starWarsClient = new StarWarsHttpClient_default();
  }
  async getStarWars() {
    try {
      const response = await this.starWarsClient.getStarWars();
      if (response !== null) {
        const formattedResponse = StarWarsTransformers_default.formatStarWarsResponse(response);
...
var getStarWars = async (event, context) => {
  try {
...
var handler = (0, import_core.default)(getStarWars);
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=StarWarsController.js.map
